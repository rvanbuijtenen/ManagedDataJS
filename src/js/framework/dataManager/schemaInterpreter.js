/**
 * ParseSchema takes a regular JSON schema as input and returns a modified version of the Schema that is
 * suitable for managed data
 *
 * @param {Object} schema - A JSON schema containing a main Klass definition and optionally a set of definitions that describe sub-Klasses
 * @return {Array} An array containing all Klasses that were defined within the schema
 */
export let parseSchema = function(schema) {
	let interpreter = new SchemaInterpreter();
	return interpreter.parseSchema(schema)
}
